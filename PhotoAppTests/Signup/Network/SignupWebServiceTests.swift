...
final class SignupWebServiceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        signFormRequestModel = SignFormRequestModel(firstName: "Mick", lastName: "Mi", email: "test@email.com", password: "123456")
    }
    ...
    func testSignupWebService_WhenEmptyURLStringProvided_ReturnErrors() {
        // Arrange
    ...
    func testSignupWebService_WhenURLRequestFails_ReturnErrorMessageDescription() {
        ...
        let errorDescription = "A localized descritpiton of an error"
